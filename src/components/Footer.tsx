        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/" onClick={() => window.scrollTo(0, 0)} className="text-gray-300 hover:text-primary transition-colors duration-300">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/what-we-done" onClick={() => window.scrollTo(0, 0)} className="text-gray-300 hover:text-primary transition-colors duration-300">
                  What We've Done
                </Link>
              </li>
              <li>
                <Link to="/upcoming-events" onClick={() => window.scrollTo(0, 0)} className="text-gray-300 hover:text-primary transition-colors duration-300">
                  Upcoming Events
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href="tel:+447411642306" className="text-gray-300 hover:text-primary transition-colors duration-300 text-sm">
                  +44-7411642306
                </a>
              </li>
              <li className="flex items-center space-x-3">
                <Mail size={20} className="text-primary flex-shrink-0" />
                <a href="mailto:ssukconnect@gmail.com" className="text-gray-300 hover:text-primary transition-colors duration-300 text-sm">
          ...
          <div>
            ...
            <div className="bg-pageBg p-3 rounded-lg inline-block border-2 border-maroon">
              <img
                ...
                className="w-32 h-32"
              />
              <p className="text-center text-xs text-gray-900 mt-2 font-medium">Scan to WhatsApp</p>
            </div>
          </div>
        </div>
